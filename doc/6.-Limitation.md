...
For example, while the device is reporting `t0003001122[CR]`, if the four characters `3001` are lost, `t000122[CR]` is reported.
...
The device is implemented according to this policy, and it is recommended that the host-side implementation follow the same approach.
