...
's' |   ?   |  sxxyy[CR]            | Sets up CAN nominal bit rate and bit timing,                  |  A
    |       |                       | where xx and yy are hex values.                               |
    |  YES  |  sddxxyyzz[CR]        | Sets up CAN FD nominal bit rate and bit timing,               | CY
...
'y' |  YES  |  yddxxyyzz[CR]        | Sets up CAN FD data bit rate and bit timing,                  | CY
    |       |                       | where dd, xx, yy and zz are hex values.                       |
...
'd' |  YES  |  diiildd...[CR]       | Transmits a FD base data frame without bit rate switch.       |  E
'D' |  YES  |  Diiiiiiiildd...[CR]  | Transmits a FD extended data frame without bit rate switch.   |  E
'b' |  YES  |  biiildd...[CR]       | Transmits a FD base data frame with bit rate switch.          |  E
'B' |  YES  |  Biiiiiiiildd...[CR]  | Transmits a FD extended data frame with bit rate switch.      |  E
...
'X' |   -   |  Xn[CR]               | Sets Auto Poll/Send ON/OFF for received frames.               |  A
    |  YES  |  X[CR]                | Sets the device to firmware update mode.                      | BC
...
'I' |  YES  |  I[CR]                | Gets CAN FD controller information.                           | DY
'i' |  YES  |  i[CR]                | Gets detailed CAN FD controller information.                  | DY
...
- `C` : [USB2CANFDV1](https://github.com/WeActStudio/WeActStudio.USB2CANFDV1) project.
- `D` : a suggestion on [mikrocontroller.net](https://www.mikrocontroller.net/topic/501223).
- `E` : [Hadou-CAN](https://github.com/suburbanmarine/hadoucan-fw) project.
