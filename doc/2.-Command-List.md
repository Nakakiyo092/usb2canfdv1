...
- `C` : [CANable 2.0](https://github.com/normaldotcom/canable2-fw) project.
- `D` : [USB2CANFDV1](https://github.com/WeActStudio/WeActStudio.USB2CANFDV1) project.
- `E` : a suggestion on [mikrocontroller.net](https://www.mikrocontroller.net/topic/501223).
