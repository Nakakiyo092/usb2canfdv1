...
waiting to be parsed into SLCAN commands.
...
The generator converts each frame into an Rx report in SLCAN text
format and enqueues the report into the CDC Tx Buffer for
